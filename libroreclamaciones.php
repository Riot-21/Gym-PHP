    ...
    <body data-spy="scroll" data-target="#navbarNav" data-offset="50">
        ...
        <section class="hero d-flex flex-column justify-content-center align-items-center" id="home">
            ...
            <div class="container">
                ...
                <?php require_once './MENUPRINCIPAL/formulariolibroreclamacion.php' ?>;
                    ...
                    <div class="d-flex justify-content-center mx-auto col-lg-5 col-md-7 col-12">
                        ...
                        <div>
                            ...
                            <ul class="social-icons">
                                <a href="https://fb.com/tooplate" target="_blank"><i class="fab fa-facebook-square"></i></a>
                                <a href="https://www.instagram.com/smartfitgym474" target="_blank"><i class="fab fa-instagram"></i></a>
                                <a href="https://twitter.com/TuCuentaDeTwitter" target="_blank"><i class="fab fa-twitter"></i></a>
                            </ul>
